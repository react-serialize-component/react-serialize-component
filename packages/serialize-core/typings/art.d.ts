declare module 'art-template/lib/template-web' {
  type artTemplateDefaults = {
    /**
     * template name
     */
    filename?: string;
   ...
   */
  function artTemplate(filenameOrTemplateId: string, content?: string | Object): any;
  namespace artTemplate {
